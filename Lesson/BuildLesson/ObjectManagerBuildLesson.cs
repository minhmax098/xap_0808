...
public class ObjectManagerBuildLesson : MonoBehaviour
{
    ...
    public void InitOriginalExperience()
    {
        ...
        // LabelManagerBuildLesson.Instance.updateCenterPosition();  // Khong hieu TagHander co roi thi cai LabelManager cos y nghia gif nuwax
    }
    ...
    {   
        ...
        onInitOrganSuccessfully?.Invoke(); //  Nay la cai gì ????
        // onReadyModel?.Invoke();
    }
